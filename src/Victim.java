...
public class Victim extends Documentary {
	
	private String type;     //declaring fields

	public Victim() {    //without arguments constructor
		super();
	}


	public Victim(String type,String name, String gender, int age, String address, String height, String weight, String color, 
	...
	public String getType() {   //getter setter methods
		return type;
	}
